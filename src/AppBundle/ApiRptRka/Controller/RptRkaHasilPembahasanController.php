...
class RptRkaHasilPembahasanController extends Controller
{
    ...
    public function getDataReport()
    {
        ...
        /*$id_pembahasan = $this->request->query->get("id_pembahasan");
        $tgl_pembahasan = $this->request->query->get("tgl_pembahasan");*/
