...
class RptRenjaRekapProgramController extends Controller
{
...
//                     $value1->renja_program_id_rkpd_program = $value1->renja_program_id_rkpd_program;
//                     $value1->renja_program_kd_program = $value1->renja_program_kd_program;
                    ...
                    $value1->renja_program_pagu_indikatif_ = doubleval($value1->renja_program_pagu_indikatif_);
                    $value1->renja_program_pagu_indikatif_ = doubleval($value1->renja_program_pagu_indikatif_);
...
//             $mapSikdInfo[$sikdInfoBlock->id_sikd_kgtn] = $infoListKgtn;
            //PROGRAM
...
//             $mapSikdInfo[$sikdInfoBlock->sikd_prog_id] = $infoListProg;
            //BIDANG
...
//             $mapSikdInfo[$sikdInfoBlock->sikd_bidang_id] = $infoListBidang;
            //URUSAN
            $infoListUrusan['sikd_urusan_id'] = $sikdInfoBlock->sikd_urusan_id;
            $infoListUrusan['sikd_urusan_nm_urusan'] = $sikdInfoBlock->sikd_urusan_nm_urusan;
            $infoListUrusan['sikd_urusan_kd_urusan'] = $sikdInfoBlock->sikd_urusan_kd_urusan;
            $urusanList[$sikdInfoBlock->sikd_urusan_id] = $infoListUrusan;
//             $mapSikdInfo[$sikdInfoBlock->sikd_urusan_id] = $infoListUrusan;
        }
