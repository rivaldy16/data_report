...
class RptRenjaPermen546c6Controller extends Controller
{
    ...
    public function getDataReport()
    {
        ...
        foreach ($renjaReports as &$value1) {
                    ...
                    if ($value1->renja_anggaran_sikd_bidang_id != null){
                    $value1->sikd_urusan_id_sikd_urusan = $mapSikdBidang['bidang'][$value1->renja_anggaran_sikd_bidang_id]['sikd_urusan_id'];
                    $value1->sikd_urusan_kd_urusan = $mapSikdBidang['bidang'][$value1->renja_anggaran_sikd_bidang_id]['sikd_urusan_kd_urusan'];
                    $value1->sikd_urusan_nm_urusan = $mapSikdBidang['bidang'][$value1->renja_anggaran_sikd_bidang_id]['sikd_urusan_nm_urusan'];
                    ...
                    $value1->sikd_bidang_nm_bidang = $mapSikdBidang['bidang'][$value1->renja_anggaran_sikd_bidang_id]['nm_bidang'];
                        ...
                        $value1->sikd_urusan_id_sikd_urusan = '';
                        $value1->sikd_urusan_kd_urusan = '';
                        $value1->sikd_urusan_nm_urusan = '';
                        $value1->sikd_bidang_id_sikd_bidang = '';
                        $value1->sikd_bidang_kd_bidang = '';
                        $value1->sikd_bidang_nm_bidang = '';
                    }
