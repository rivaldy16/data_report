...
class RptRkpdLampPermen231dModController extends Controller
{
    private $uriRestRkpd;
    private $uriRestSikd;
    private $restClient;
    ...
    public function getDataReport()
    {
        ...
        foreach ($rkpdReports as &$value1) {
            ...
            if ($renjaRkpdInfo3 != null){
                ...
                $value1->rkpd_prioritas_kab_id_rkpd_prioritas_kab = null;
                $value1->rkpd_prioritas_no_prioritas = null;
                $value1->rkpd_prioritas_nm_program = null;
            }
            ...
            if ($renjaRkpdInfo4 != null){
                ...
                $value1->rkpd_sasaran_id_rkpd_sasaran = null;
                $value1->rkpd_sasaran_no_sasaran = null;
                $value1->rkpd_sasaran_uraian_sasaran = null;
            }
